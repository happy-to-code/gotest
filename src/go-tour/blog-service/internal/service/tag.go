...
type CountTagRequest struct {
	...
	State uint8  `form:"state,default=1.json" binding:"oneof=0 1.json"`
}
...
type UpdateTagRequest struct {
	ID         uint32 `form:"id" binding:"required,gte=1.json"`
	Name       string `form:"name" binding:"max=100"`
	State      uint8  `form:"state" binding:"oneof=0 1.json"`
